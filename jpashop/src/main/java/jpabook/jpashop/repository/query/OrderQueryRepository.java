...
public class OrderQueryRepository {
	...
	private Map<Long, List<OrderItemQueryDto>> findOrderItemMap(List<Long> orderIds) {
		// @formatter:off
		List<OrderItemQueryDto> orderItems = em
				.createQuery("select new jpabook.jpashop.repository.query.OrderItemQueryDto(oi.order.id, i.name, oi.orderPrice, oi.count)" + 
								" from OrderItem oi" +
								" join oi.item i" +
